...
<head>
    ...
    <script src="/api/b2b/js/jquery-1.11.1.min.js"></script>
    <script src="/api/b2b/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="/api/b2b/js/handlebars-1.0.0.beta.6.js"></script>
    <script type="text/javascript" src="/api/b2b/js/jlinq.js"></script>
    <script type="text/javascript" src="/api/b2b/js/prettify.js"></script>

    <!-- Le styles -->
    <link href="/api/b2b/css/bootstrap.min.css" rel="stylesheet">
    <style type="text/css">
